            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
              <form className="relative flex flex-1" onSubmit={handleSubmit}>
                ...
                <input
                  ...
                  placeholder="Search your favourite food in Vancouver..."
                  type="search"
                  name="search"
                  value={message}
                ...
                <Menu as="div" className="relative">
                  ...
                  <Menu.Button className="-m-1.5 flex items-center p-1.5">
                    ...
                    <img
                      ...
                      src={avatar ? avatar :"https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"}
                      alt=""
                    />
